...
describe('Course API:', function() {
  ...
  describe('PUT /api/courses/:id', function() {
    ...
    it('should respond with the original course', function() {
      expect(updatedCourse.name).to.equal('New Course');
      expect(updatedCourse.info).to.equal('This is the brand new course!!!');
    });
    ...
    it('should respond with the updated course on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(course.name).to.equal('Updated Course');
          expect(course.info).to.equal('This is the updated course!!!');
  ...
  describe('PATCH /api/courses/:id', function() {
    ...
    it('should respond with the patched course', function() {
      expect(patchedCourse.name).to.equal('Patched Course');
      expect(patchedCourse.info).to.equal('This is the patched course!!!');
    });
  });
